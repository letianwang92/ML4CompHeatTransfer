function []=generate_data_set_random_fun(L,ratio,sinkP,list_start,loop_num,isFigure,plotNum)
close all
...
switch Mode
    ...
    case 4
        ...
        loop_mid=1;
        record=zeros(loop_num*loop_mid,L^2+3);
...
%% save files
saveFile=strcat('Records_mesh_',num2str(idxMesh),'_comNum_',num2str(loop_num),'_',filename);
