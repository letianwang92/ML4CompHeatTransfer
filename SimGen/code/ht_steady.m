function [HeatRate,Qflux,thermalmodel,thermalresults] = ht_steady(L,XY,Qin,Tcold,k_pair,MeshSize,isFigure,isEvaluate)
...
k_high=k_pair(2);
D=1; % default level
[dl,EdgeN,faceMax,face_domain]=geom2d_whole(L,D,X,Y,isFigure);
